...
use kairos_terminal::term::TermMode;
...
pub enum Action {
    ...
    /// Hide the Kairos window.
    Hide,

    /// Hide all windows other than Kairos on macOS.
    HideOtherApplications,

    /// Minimize the Kairos window.
    Minimize,
    ...
    /// Spawn a new instance of Kairos.
    SpawnNewInstance,
