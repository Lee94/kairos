...
impl Font {
    ...
    /// Get a font clone with the normal face's family replaced. Bold/italic faces that fall back to
    /// the normal family follow along; faces with an explicit family are left untouched.
