...
use kairos_config_derive::{ConfigDeserialize, SerdeReplace};
use kairos_terminal::term::Config as TermConfig;
use kairos_terminal::term::search::RegexSearch;
use kairos_terminal::tty::{Options as PtyOptions, Shell};
...
pub struct UiConfig {
    ...
    /// Config for the kairos_terminal itself.
