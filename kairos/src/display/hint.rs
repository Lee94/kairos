...
use kairos_terminal::grid::{BidirectionalIterator, Dimensions};
use kairos_terminal::index::{Boundary, Column, Direction, Line, Point};
use kairos_terminal::term::cell::Hyperlink;
use kairos_terminal::term::search::{Match, RegexIter, RegexSearch};
use kairos_terminal::term::{Term, TermMode};
...
#[cfg(test)]
mod tests {
    use kairos_terminal::index::{Column, Line};
    use kairos_terminal::term::test::mock_term;
    use kairos_terminal::vte::ansi::Handler;
