...
use kairos_terminal::index::{Boundary, Column, Direction, Point, Side};
use kairos_terminal::selection::SelectionType;
use kairos_terminal::term::search::Match;
use kairos_terminal::term::{ClipboardType, Term, TermMode};
use kairos_terminal::vi_mode::ViMotion;
use kairos_terminal::vte::ansi::{ClearMode, Handler};
...
mod tests {
    ...
    use kairos_terminal::event::Event as TerminalEvent;
