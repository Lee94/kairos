//! Kairos - The GPU Enhanced Terminal.
...
/// Temporary files stored for Kairos.
///
...
/// Run main Kairos entrypoint.
///
/// Creates a window, the terminal state, PTY, I/O event loop, input processor,
/// config change monitor, and runs the main display loop.
fn kairos(mut options: Options) -> Result<(), Box<dyn Error>> {
