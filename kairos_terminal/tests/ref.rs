...
use kairos_terminal::event::{Event, EventListener};
use kairos_terminal::grid::{Dimensions, Grid};
use kairos_terminal::index::{Column, Line};
use kairos_terminal::term::cell::Cell;
use kairos_terminal::term::test::TermSize;
use kairos_terminal::term::{Config, Term};
use kairos_terminal::vte::ansi;
...
fn ref_test(dir: &Path) {
    let recording = read_u8(dir.join("kairos.recording"));
